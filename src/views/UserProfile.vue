<template>
 <div class="lg:w-[80%] md:w-[90%] w-[96%] mx-auto flex gap-4">
  <div
          class="lg:w-[88%] sm:w-[88%] w-full mx-auto shadow-2xl p-4 rounded-xl h-fit self-center dark:bg-gray-400">
          <!--  -->
          <div class="">
              <h1
                  class="lg:text-3xl md:text-2xl text-xl text-center mb-2 dark:text-white">
                  User Profile
              </h1>
  ...
  <div class="flex flex-col justify-center w-full">
      ...
      <div class="w-full  mb-4 mt-6">
        ...
        <input type="text"
          v-model="firstName"
          id="first_name"
          class="px-4  w-full py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          required
        />
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      profileImagePreview: "", // For profile image preview
    };
  },
  mounted() {
  ...
  methods: {
    loadUserProfile() {
      ...
      this.profileImagePreview =
        localStorage.getItem("profile_image") || ""; // Load profile image preview if available
    },
    ...
    handleImageUpload(event) {
      ...
      if (file) {
        ...
        reader.onload = (e) => {
          this.profileImagePreview = e.target.result; // Update preview data
          localStorage.setItem("profile_image", this.profileImagePreview); // Save to localStorage
        };
