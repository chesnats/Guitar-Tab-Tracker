<template>
  <div class="absolute mt-2 z-10 ml-[10px] w-[130px] h-[100px] bg-cover bg-center" style="background-image: url('src/assets/gJW40PvAOx16R44UE4-ezgif.com-video-to-gif-converter.gif');"></div>
    <!-- Loading Overlay -->
